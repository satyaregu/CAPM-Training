...
context transaction {
    ...
    entity purchaseorder : common.amount, cuid { //using Custom Aspect amount
            //This table will have all fields from amount aspect
        //key NODE_KEY         : common.Guid @title : '{i18n>PO_KEY}'; //Using Custom Type
            ...
            //Inserting Composition with poitems table with self key. i.e. NODE_KEY of purchaseorder table
...
//testing git commit. changes.. testing the changes with graphical editor